...
public class IconViewPager extends LinearLayout implements ViewPager.OnPageChangeListener {
	...
	public IconViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public IconViewPager(Context context, AttributeSet attrs, int defStyle) {
	...
	private void addTab(int index, CharSequence text, int iconResId) {
		...
		mTabLayout.addView(tabView, new LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 1));
	}
